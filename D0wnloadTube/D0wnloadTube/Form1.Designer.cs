namespace D0wnloadTube
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            AudioCb = new Guna.UI2.WinForms.Guna2ToggleSwitch();
            VideoCb = new Guna.UI2.WinForms.Guna2ToggleSwitch();
            ...
            Panel.Controls.Add(AudioCb);
            Panel.Controls.Add(VideoCb);
            ...
            label3.TabIndex = 55;
            label3.Text = "Audio Only";
            // 
            // label7
            // 
            label7.AutoSize = true;
            label7.ForeColor = Color.White;
            label7.Location = new Point(2, 28);
            label7.Name = "label7";
            label7.Size = new Size(65, 15);
            label7.TabIndex = 56;
            label7.Text = "Video Only";
            // 
            // D0wnloadTube
            // 
            D0wnloadTube.AutoSize = true;
            D0wnloadTube.ForeColor = Color.White;
            D0wnloadTube.Location = new Point(144, 61);
            ...
            // AudioCb
            // 
            AudioCb.Animated = true;
            AudioCb.Checked = true;
            AudioCb.CheckedState.BorderColor = Color.LightGray;
            AudioCb.CheckedState.FillColor = Color.LightGray;
            AudioCb.CheckedState.InnerBorderColor = Color.White;
            AudioCb.CheckedState.InnerColor = Color.White;
            AudioCb.CustomizableEdges = customizableEdges5;
            AudioCb.Location = new Point(73, 46);
            AudioCb.Name = "AudioCb";
            AudioCb.ShadowDecoration.CustomizableEdges = customizableEdges6;
            AudioCb.Size = new Size(65, 20);
            AudioCb.TabIndex = 54;
            AudioCb.UncheckedState.BorderColor = Color.FromArgb(125, 137, 149);
            AudioCb.UncheckedState.FillColor = Color.FromArgb(125, 137, 149);
            AudioCb.UncheckedState.InnerBorderColor = Color.White;
            AudioCb.UncheckedState.InnerColor = Color.White;
            // 
            // VideoCb
            // 
            VideoCb.Animated = true;
            VideoCb.Checked = true;
            VideoCb.CheckedState.BorderColor = Color.LightGray;
            VideoCb.CheckedState.FillColor = Color.LightGray;
            VideoCb.CheckedState.InnerBorderColor = Color.White;
            VideoCb.CheckedState.InnerColor = Color.White;
            VideoCb.CustomizableEdges = customizableEdges7;
            VideoCb.Location = new Point(2, 46);
            VideoCb.Name = "VideoCb";
            VideoCb.ShadowDecoration.CustomizableEdges = customizableEdges8;
            VideoCb.Size = new Size(65, 20);
            VideoCb.TabIndex = 53;
            VideoCb.UncheckedState.BorderColor = Color.FromArgb(125, 137, 149);
            VideoCb.UncheckedState.FillColor = Color.FromArgb(125, 137, 149);
            VideoCb.UncheckedState.InnerBorderColor = Color.White;
            VideoCb.UncheckedState.InnerColor = Color.White;
            // 
            // pbDownload
            // 
            pbDownload.BackColor = Color.Transparent;
            pbDownload.CustomizableEdges = customizableEdges9;
            ...
            label5.Location = new Point(171, 13);
            label5.Name = "label5";
            ...
            Progresslbl.Location = new Point(295, 9);
            ...
            txtUrl.Location = new Point(0, 94);
            txtUrl.Name = "txtUrl";
            ...
            label1.TabIndex = 30;
            label1.Text = "Click both for both";
            // 
            // timer1
            // 
            timer1.Enabled = true;
        ...
        private Guna.UI2.WinForms.Guna2ToggleSwitch AudioCb;
        private Guna.UI2.WinForms.Guna2ToggleSwitch VideoCb;
